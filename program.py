#produce = {'oranges': 2.99, 'bananas': 0.99, 'lettuce': 3.99, 'apples': 3.18}
#deli = {'CheddarJack': 3.49, 'Potato Salad': 5.79, 'Hot Case Chicken': 2.79, 'Salami': 6.99}
#bakery = {'Muffins': 2.67, 'Whole Wheat Bread': 1.99, 'Chocolate Cake': 12.35, 'Dinner Rolls': 3.67, 'Donut Holes': 2.99}
#meat = {'fajita veggies': 5.99, 'brisket': 9.99, 'Salmon': 6.87, 'Chicken Breast': 5.77}
